...
VARIABLES = {
    ...
    "여성채용구성격차": {
        "column": "여성채용구성격차", "label": "여성 채용구성 격차", "domain": "인사 결과", "category": "채용",
        "unit": "%p", "description": "여성신규채용비율 - 여성직원비율 (양수: 신규채용의 여성 비중이 기존 인력구성보다 높음)",
        "log_allowed": False, "percent": False,
        "question": "이 값이 양수인 기관은 앞으로도 계속 그럴까요? 이 데이터만으로는 미래를 예측할 수 없습니다.",
    },
    "청년신규채용자수": {
