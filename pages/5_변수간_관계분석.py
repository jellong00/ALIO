...
PRESETS = {
    ...
    "[성별·일가정양립] 여성직원비율 ↔ 남성육아휴직사용률": ("여성직원비율", "남성육아휴직사용률"),
    "[성별·일가정양립] 1인당복리후생비 ↔ 여성육아휴직사용률": ("1인당복리후생비", "여성육아휴직사용률"),
...
if rows:
    ...
    st.caption("💡 전체 상관관계와 기관유형별 상관관계가 다르게 나타난다면, 심슨의 역설(Simpson's paradox) 가능성을 의심해볼 수 있습니다.")
else:
